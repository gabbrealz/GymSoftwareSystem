        ...
        <div className="space-y-10">
            ...
            <div className="bg-[#303030] p-6 rounded-[10px] shadow-lg border border-white/5">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-semibold text-gray-200">Attendance Analytics</h2>
                    <select
            ...
            <div className="rounded-[10px] overflow-hidden border border-white/5 shadow-xl" style={{ backgroundColor: '#303030cc' }}>
                <table className="w-full text-sm">
                    ...
                    <tbody>
                        {logs.map((log, index) => (
                            <tr key={index} className="transition-colors duration-150 hover:bg-white/5 border-b border-white/5 last:border-none">
                                ...
                                <td className="px-6 py-4 text-medium text-white">{log.memberId}</td>
