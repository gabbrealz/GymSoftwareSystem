    ...
    <div className="bg-full full-screen flex m-0 p-0 overflow-hidden bg-[#1a1a1a]">
        ...
        >
            ...
            <>
                ...
                <div className="bg-[#303030]/80 backdrop-blur-sm p-6 rounded-[10px] shadow-lg border border-white/5">
                    <h2 className="text-xl font-semibold mb-4 text-gray-200">Weekly Gym Logs</h2>
                    <p className="text-lg text-white font-medium">Ari <span className="text-gray-400 text-sm ml-2">— Member</span></p>
                </div>
